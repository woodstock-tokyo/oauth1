...
func (c *Config) RequestToken(headers *map[string]string) (requestToken, requestSecret string, err error) {
...
func (c *Config) AccessToken(requestToken, requestSecret, verifier string, headers *map[string]string) (accessToken, accessSecret string, err error) {
