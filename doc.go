...
To implement "Login with X", use the https://github.com/woodstock-tokyo/gologin
...
* https://github.com/woodstock-tokyo/go-twitter
* https://github.com/woodstock-tokyo/go-digits
